import { gymUserSignupAction } from "../../features/auth/gym-user-signup/gym-user-signup-action"
import { GymUserSignupForm } from "../../features/auth/gym-user-signup/gym-user-signup-form"

export const action = gymUserSignupAction
