...
- Remaining work: add Postgres adapters/tests for system admin bootstrap/authentication, gym repository, staff invitations, broader token/session digest lookup coverage, database constraints, and true restart durability against a live database.
